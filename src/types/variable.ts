...
export const VARIABLE_META: Record<Variable, VariableMeta> = {
  ...
  CURRENT_C: { label: 'Corriente C', unit: 'A', colorMode: 'neutral' },
  VOLTAGE_A: { label: 'Voltaje A', unit: 'V', colorMode: 'neutral' },
  VOLTAGE_B: { label: 'Voltaje B', unit: 'V', colorMode: 'neutral' },
  VOLTAGE_C: { label: 'Voltaje C', unit: 'V', colorMode: 'neutral' },
  ...
  POWER_ACTIVE_INST_C: { label: 'Potencia activa C', unit: 'W', colorMode: 'power' },
  ...
  POWER_ACTIVE_TOTAL_POS: {
    label: 'Energía importada (acumulada)',
    unit: 'kWh',
    colorMode: 'import',
  },
  POWER_ACTIVE_TOTAL_NEG: {
    label: 'Energía exportada (acumulada)',
    unit: 'kWh',
    colorMode: 'export',
  },
};
