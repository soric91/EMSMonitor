          ...
          <Card className="flex items-start gap-3">
            ...
            <div className="min-w-0">
              ...
              <p className="mt-1 text-sm leading-relaxed text-slate-600 dark:text-slate-300">
                ...
                <strong>hasta ~{formatCop(eff.potential_savings_cop)}</strong> este mes si hubieras
                desplazado consumo a tus horas de mayor generación
                {peakExportLocal !== null && <> (alrededor de las {peakExportLocal}:00)</>}.
              </p>
              <p className="mt-1 text-[11px] text-slate-400">
                Estimación tope: solo cuenta el excedente que superó lo importado ese mes (el resto
                ya se paga al precio de importación). Asume autoconsumirlo en vez de venderlo a{' '}
